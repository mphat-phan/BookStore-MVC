            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Esrb</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Esrb table</h3>
                    ...
                    <form id="formAdd" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Esrb Name</label>
                                <input name="txtName" type="text" class="form-control formUpdateInput"
                                    placeholder="Enter ">
                            </div>
                            <div class="form-group w-25">
                                <label for="exampleInputEmail1">Esrb Image</label>
                                <input name="txtImage" id="txtImage" type="file" accept="image/*" class="form-control "
                                    placeholder="Enter ">
                                <img id="imageEsrbAdd" class="img-fluid " src="" alt="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Esrb Description</label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group w-25">
                                ...
                                <input name="txtImage" id="txtImageUpdate" type="file" accept="image/*" class="form-control "
                                    placeholder="Enter ">
                                <img id="imageEsrb" class="img-fluid " src="" alt="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Esrb Description</label>
                                <input name="txtDetail" type="text" class="form-control formUpdateInput"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#UpdateModal input[type="file"]').change(function(e) {
                ...
                $("#imageEsrb").fadeIn("fast").attr('src',URL.createObjectURL(e.target.files[0]));
                    
            });
        
            $('#AddModal input[type="file"]').change(function(e) {
                        
                $("#imageEsrbAdd").fadeIn("fast").attr('src',URL.createObjectURL(e.target.files[0]));
                    
            });

            esrbtable = $('#esrbtable').DataTable({            
            dom: 'Bfrtip',
            "scrollY": true,
            "ajax": "<?php echo constant('URL') ?>esrb/getall",
            "columns": [{
                    "data": "id"
                },
                {
    ...
    function openModal(e){
        $getCurrentUrl = '<?php echo constant('URL') ?>esrb';
        id=$(e).attr('data_id');
        const x = document.forms["formUpdate"];
        var name,detail;
        $.ajax({
            type: "POST",
            url: '<?php echo constant('URL') ?>esrb/getByID/'+id,
            dataType: 'json',
            success: function(data){
                x.elements[0].value = data['data'][0].name;     
                x.elements[2].value = data['data'][0].detail;     
              
                $('#txtImageUpdate').val('');
                $("#imageEsrb").attr("src","<?php echo constant('URL') ?>public/assets/images/"+data['data'][0].image)
            }
        });
