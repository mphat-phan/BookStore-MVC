                    ...
                    <form id="formAdd" action="" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name='txtDiscount' type="number" class="form-control formUpdateInput"
                                    placeholder="Enter " required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sale Start Date</label>
                                <input name='txtStartDate' type="date" class="form-control formUpdateInput"
                                    placeholder="Enter " required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sale End Date</label>
                                <input name='txtEndDate' type="date" class="form-control formUpdateInput"
                                    placeholder="Enter " required>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    $(document).ready(function () {
        saletable = $('#saletable').DataTable({            
            dom: 'Bfrtip',
            "ajax": "<?php echo constant('URL') ?>sale/getall",
            "columns": [{
                    "data": "id"
                },
                {
    ...
    function openModal(e){
        $getCurrentUrl = '<?php echo constant('URL') ?>sale';
        id=$(e).attr('data_id');
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                x.elements[1].value = data['data'][0].quantity;
                x.elements[2].value = data['data'][0].discount;
                x.elements[3].value = data['data'][0].startdate;
                x.elements[4].value = data['data'][0].enddate;
                x.elements[5].value = data['data'][0].minorder;
                x.elements[6].value = data['data'][0].maxsale;
