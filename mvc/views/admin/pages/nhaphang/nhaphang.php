        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Nhập hàng table</h3>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Chi tiết nhập hàng table</h3>

                            <button type="button" onclick="" href="#" class="btn btn-primary btn-sm float-right" role="button"
                                data-toggle="modal" data-target="#AddModal2">Add</button>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="chitietnhaphangtable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Rendering engine</th>
                                        <th>Browser</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a onclick="" href="#" class="btn btn-warning btn-sm" role="button"
                                                data-toggle="modal" data-target="#UpdateModal2">Update</a>
                                            <a onclick="" href="#" class="btn btn-danger btn-sm" role="button"
