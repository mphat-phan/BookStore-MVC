               ...
               <div class="col-12">
                   ...
                   <div class="card">
                       <div class="card-header">
                           ...
                           <button type="button" onclick="openModalCompany('')" href="#"
                           ...
                           <table id="companytable" class="table table-bordered table-striped">
                               ...
                               <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td><?=$row['email']?></td>
                                       <td><?=$row['address']?></td>
                                       <td><a onclick='openModalCompany(<?php echo json_encode($row)?>)' href="#"
                                               class="btn btn-warning btn-sm" role="button" data-toggle="modal"
                                               data-target="#UpdateModal">Update</a>
                                           <a onclick='openModalCompany(<?php echo json_encode($row)?>)' href="#"
                   ...
                   <form id="formAdd" action="" method="post">
                       ...
                       <div class="card-body">
                           ...
                           <div class="form-group">
                               ...
                               <input name='txtEmail' type="text" class="form-control formUpdateInput"
                                   placeholder="Enter ">
                           </div>
                           <div class="form-group">
                               <label for="exampleInputEmail1">Company Address</label>
                               <input name='txtAddress' type="text" class="form-control formUpdateInput"
                                   placeholder="Enter ">
                           </div>
               ...
               <div class="card card-primary">
                   ...
                   <form id="formUpdate" action="" method="POST">
                       ...
                       <div class="card-body">
                           <div class="form-group">
                               <label for="exampleInputEmail1">Company Name</label>
                               <input name="txtName" type="text" class="form-control" id="CompanyName"
                                   placeholder="Enter ">
                           </div>
                           <div class="form-group">
                               <label for="exampleInputEmail1">Company Email</label>
                               <input name='txtEmail' type="email" class="form-control" id="CompanyEmail"
                                   placeholder="Enter ">
                           </div>
                           <div class="form-group">
                               <label for="exampleInputEmail1">Company Address</label>
                               <input name='txtAddress' type="text" class="form-control" id="CompanyAddress"
                                   placeholder="Enter ">
                           </div>
                           <!-- /.card-body -->
                           <div class="card-footer">
